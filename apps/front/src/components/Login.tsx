        ...
        <form onSubmit={handleSubmit} className="mt-16 space-y-6">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 px-4 py-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-white dark:placeholder-gray-400"
            />
          </div>
