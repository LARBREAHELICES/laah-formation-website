...
export default function ContactSection() {
  return (
    <section id="contact" className="relative isolate bg-white py-32 sm:py-40">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-20 grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <form className="space-y-6">
            {[
              ...
              <div key={id}>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  required
                />
              </div>
            ))}
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-indigo-600 py-3 text-sm font-semibold text-white shadow-md hover:bg-indigo-500"
            >
